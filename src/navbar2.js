            ...
            <Nav>
              ...
              >
                ...
                <p className="logohome2 logo1left ">
                  <img className="navlink" src={github} alt="logo" />
                </p>{" "}
              </Nav.Link>
              <Nav.Link
                className="logohome"
              ...
              >
                {" "}
                <p className="logohome2 logo1left ">
                  <img className="navlink" src={discord} alt="logo" />
                </p>{" "}
              </Nav.Link>
              <Nav.Link className="logohome" href="https://t.me/warthognetwork">
                {" "}
                <p className="logohome2 logo1left ">
                  <img className="navlink" src={telegram} alt="logo" />
                </p>{" "}
              </Nav.Link>
              <Nav.Link
                className="logohome"
              ...
              >
                {" "}
                <p className="logohome2 logo1left ">
                  <img className="navlink" src={twitter} alt="logo" />
                </p>{" "}
              </Nav.Link>
            </Nav>
          )}{" "}
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className=" me-auto">
            ...
            <Nav.Link
              className="logohome "
              as={Link}
              to={"https://www.warthog.network/docs/"}
            >
